...
@Crud({
  ...
  routes: {
    createManyBase: {
      decorators: [Permissions(Permission.WarehouseCreateMany)],
    },
    createOneBase: {
      decorators: [Permissions(Permission.WarehouseCreateOne)],
    },
    updateOneBase: {
      decorators: [Permissions(Permission.WarehouseUpdateOne)],
    },
    replaceOneBase: {
      decorators: [Permissions(Permission.WarehouseReplaceOne)],
    },
    deleteOneBase: {
      decorators: [Permissions(Permission.WarehouseDeleteOne)],
    },
    recoverOneBase: {
      decorators: [Permissions(Permission.WarehouseRecoverOne)],
    },
    getManyBase: {
      decorators: [Permissions(Permission.WarehouseReadAll)],
    },
    getOneBase: {
      decorators: [Permissions(Permission.WarehouseReadOne)],
    },
  },
  // Override DTOs
  dto: {
