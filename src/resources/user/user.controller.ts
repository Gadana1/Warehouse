...
@Crud({
  ...
  routes: {
    createManyBase: {
      decorators: [Permissions(Permission.UserCreateMany)],
    },
    createOneBase: {
      decorators: [Permissions(Permission.UserCreateOne)],
    },
    updateOneBase: {
      decorators: [Permissions(Permission.UserUpdateOne)],
    },
    replaceOneBase: {
      decorators: [Permissions(Permission.UserReplaceOne)],
    },
    deleteOneBase: {
      decorators: [Permissions(Permission.UserDeleteOne)],
    },
    recoverOneBase: {
      decorators: [Permissions(Permission.UserRecoverOne)],
    },
    getManyBase: {
      decorators: [Permissions(Permission.UserReadAll)],
    },
    getOneBase: {
      decorators: [Permissions(Permission.UserReadOne)],
    },
  },
  // Override DTOs
  dto: {
